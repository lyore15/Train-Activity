$(document).ready(function () {
    ...
    // Initialize Firebase
    var config = {
        apiKey: "AIzaSyA6tJ0hy2Z4pOmt5-FLGjT2HD--qaQZNBY",
        authDomain: "trainschedule-c4874.firebaseapp.com",
        databaseURL: "https://trainschedule-c4874.firebaseio.com",
        projectId: "trainschedule-c4874",
        storageBucket: "trainschedule-c4874.appspot.com",
        messagingSenderId: "17732296593"
    };
    ...
    database.ref().on("child_added", function (childSnapshot) {
        ...
        $("#schedule").append("<tr><td>" + name + "</td><td>" + destination + "</td><td>" + frequency + "</td><td>" + nextTrainArr + "</td><td>" + nextTrainMin + "</td><td>" + remove + "</td></tr>");
